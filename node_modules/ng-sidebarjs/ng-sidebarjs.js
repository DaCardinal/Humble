import { Component, Directive, HostListener, Input, NgModule, Renderer2, ViewChild } from '@angular/core';
...
class SidebarJSComponent {
     ...
     */
    ngAfterContentInit() {
        const /** @type {?} */ configDomElements = this.defineConfigDomElements();
     ...
     * @return {?}
     */
    setSidebarAttributes(sidebarName = '', configDomElements) {
...
/** @nocollapse */
SidebarJSComponent.ctorParameters = () => [
    { type: sidebarjs_2, },
    { type: Renderer2, },
];
SidebarJSComponent.propDecorators = {
    "sidebarjsName": [{ type: Input },],
    "sidebarjsConfig": [{ type: Input },],
    "component": [{ type: ViewChild, args: ['component',] },],
 ...
 * @suppress {checkTypes} checked by tsc
 */
class SidebarJSToggleDirective {
    /**
     * @param {?} sidebarService
     */
...
/** @nocollapse */
SidebarJSToggleDirective.ctorParameters = () => [
    { type: sidebarjs_2, },
];
SidebarJSToggleDirective.propDecorators = {
    "sidebarjsToggle": [{ type: Input },],
    "toggle": [{ type: HostListener, args: ['click', ['$event.target'],] },],
};
...
/** @nocollapse */
SidebarJSOpenDirective.ctorParameters = () => [
    { type: sidebarjs_2, },
];
SidebarJSOpenDirective.propDecorators = {
    "sidebarjsOpen": [{ type: Input },],
    "open": [{ type: HostListener, args: ['click', ['$event.target'],] },],
};
...
/** @nocollapse */
SidebarJSCloseDirective.ctorParameters = () => [
    { type: sidebarjs_2, },
];
SidebarJSCloseDirective.propDecorators = {
    "sidebarjsClose": [{ type: Input },],
    "close": [{ type: HostListener, args: ['click', ['$event.target'],] },],
};
...
/** @nocollapse */
SidebarJSModule.ctorParameters = () => [];
...
export { SidebarJSComponent, sidebarjs_2 as SidebarJSService, SidebarJSModule, SidebarJSToggleDirective, SidebarJSOpenDirective, SidebarJSCloseDirective };
//# sourceMappingURL=ng-sidebarjs.js.map
